...
static int run_queries(void)
{
	...
	if (sock4 >= 0 && IS_ENABLED(CONFIG_NET_IPV4)) {
		...
		ret = http_client_req(sock4, &req, timeout, (void*)"IPv4 GET");
	...
	if (sock6 >= 0 && IS_ENABLED(CONFIG_NET_IPV6)) {
		...
		ret = http_client_req(sock6, &req, timeout, (void*)"IPv6 GET");
	...
	if (sock4 >= 0 && IS_ENABLED(CONFIG_NET_IPV4)) {
		...
		ret = http_client_req(sock4, &req, timeout, (void*)"IPv4 POST");
	...
	if (sock6 >= 0 && IS_ENABLED(CONFIG_NET_IPV6)) {
		...
		ret = http_client_req(sock6, &req, timeout, (void*)"IPv6 POST");
